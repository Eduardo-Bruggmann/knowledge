    ...
    <div class="article-admin">
        <b-form>
            ...
            <b-form-group v-if="mode === 'save'" label="Categoria:" label-for="article-categoryId">
                <b-form-select id="cateogry-categoryId" :options="categories" v-model="article.categoryId" />
            </b-form-group>
            <b-form-group v-if="mode === 'save'" label="Autor:" label-for="article-userId">
                <b-form-select id="cateogry-userId" :options="users" v-model="article.userId" />
            </b-form-group>
